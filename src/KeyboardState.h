...
public:
    ...
    KeyState get_key_state(KeyCode key) const;
...
inline KeyState KeyboardState::get_scancode_state(ScanCode code) const
{
    return m_scan_codes[static_cast<size_t>(code)] == 1 ? KeyState::Up : KeyState::Down; 
}
 
inline KeyState KeyboardState::get_key_state(KeyCode key) const
{
